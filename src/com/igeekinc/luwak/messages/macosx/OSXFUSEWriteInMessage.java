...
public class OSXFUSEWriteInMessage extends FUSEOpInMessage
{
	...
	public static final int kReadInMessageLength = kWriteFlagsOffset + 4;
	
	public static final int kWriteBufferStartOffset = kReadInMessageLength;
	
	public OSXFUSEWriteInMessage(FUSEInMessage parent)
	{
		super(parent);
	}
